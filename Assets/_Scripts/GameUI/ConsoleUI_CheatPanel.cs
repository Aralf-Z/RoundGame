...
namespace RoundGame.UI
{
    public class ConsoleUI_CheatPanel : UIElement<ConsoleUI_CheatPanel>
    {
        ...
        public override void Open()
        {
            ...
            DOTween.To(() => mRectTransf.anchoredPosition, x => mRectTransf.anchoredPosition = x, new Vector2(1600, 0), .5f);
        }
        ...
        public override void Hide()
        {
            ...
            //mRectTransf.DOAnchorPosX(810, .5f)
                ...
                DOTween.To(() => mRectTransf.anchoredPosition, x => mRectTransf.anchoredPosition = x, new Vector2(810, 0), .5f)
                    .OnComplete(() => gameObject.SetActive(false));
        }
