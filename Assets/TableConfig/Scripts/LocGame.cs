...
namespace cfg
{
public sealed partial class LocGame : Luban.BeanBase
{
    public LocGame(JSONNode _buf) 
    {
    ...
    public static LocGame DeserializeLocGame(JSONNode _buf)
    {
        return new LocGame(_buf);
    }
    ...
    public const int __ID__ = 2002279218;
